    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-5" style={{ background: "var(--bg)" }}>
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="font-syne text-2xl font-black" style={{ letterSpacing: "-0.4px" }}>Welcome back</h1>
          <p className="text-sm mt-1" style={{ color: "var(--t2)" }}>Sign in to your ApnaMap account</p>
        </div>
        ...
        <p className="text-center text-sm mt-6" style={{ color: "var(--t2)" }}>
          No account?{" "}
          <Link href="/auth/signup" className="font-semibold" style={{ color: "var(--accent)" }}>
            Sign up free
          </Link>
        </p>

        <p className="text-center text-sm mt-2" style={{ color: "var(--t2)" }}>
          <Link href="/explore" style={{ color: "var(--t3)" }}>Continue without account →</Link>
        </p>
      </div>
    </div>
  );
